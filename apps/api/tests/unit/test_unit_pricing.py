...
class TestModelMatching:
    ...
    def test_dated_opus_5_variant_matches_opus_5(self) -> None:
        # A dated id like "claude-opus-5-20260301" must price as claude-opus-5, never
        # fall through to the (10x cheaper) unknown-model default.
    ...
    def test_gemini_flash_lite_matches_lite_not_flash(self) -> None:
        # Longest-substring matching: the -lite variant must not price as the ~3x
        # pricier gemini-2.5-flash whose name is a substring.
